...
internal BRAM row completes after 256 words. If the controller writes 512 words
through an 8-bit storage address, the second half of the source line overwrites
the first half and the test fails.

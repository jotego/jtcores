...
//
// Provenance:
// This module is derived from earlier DualShock controller interface
// work and has since been modified in this project.
//
// Modification history:
// 2003.10.30          Optimized by K Degawa
...
always @* begin
    ...
    //  4:   W_TXD_DAT = 8'h00;       // or vibration command
     ...
     4:  W_TXD_DAT = (~o_ATT1 && i_VIB_SW1[1])? i_VIB_DAT1 : ((~o_ATT2 && i_VIB_SW2[1])? i_VIB_DAT2  :8'h00 );        // or vibration command

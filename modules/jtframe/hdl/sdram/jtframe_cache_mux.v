...
assign bank_addr0 = {1'b0, ext_addr0[SDRAM_AW-1:1]} + {1'b0, offset0};
assign bank_addr1 = {1'b0, ext_addr1[SDRAM_AW-1:1]} + {1'b0, offset1};
assign bank_addr2 = {1'b0, ext_addr2[SDRAM_AW-1:1]} + {1'b0, offset2};
assign bank_addr3 = {1'b0, ext_addr3[SDRAM_AW-1:1]} + {1'b0, offset3};
assign bank_addr4 = {1'b0, ext_addr4[SDRAM_AW-1:1]} + {1'b0, offset4};
assign bank_addr5 = {1'b0, ext_addr5[SDRAM_AW-1:1]} + {1'b0, offset5};
assign bank_addr6 = {1'b0, ext_addr6[SDRAM_AW-1:1]} + {1'b0, offset6};
assign bank_addr7 = {1'b0, ext_addr7[SDRAM_AW-1:1]} + {1'b0, offset7};

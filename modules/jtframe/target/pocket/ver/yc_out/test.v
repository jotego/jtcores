...
//     .cart3_dir  ( cart3_dir)
// );
/*wire   hsync_c, vsync_c, csync_c, CSync;
assign CSync = ~(HS ^ VS)*/

yc_out u_yc(
    .clk              ( clk        ),
    .PHASE_INC        ( 40'd80070078948 /*{phase_inc,8'b0}*/  ),
    .PAL_EN           ( 1'b0       ),
    .CVBS             ( 1'b0       ),
    .COLORBURST_RANGE ( /*colorburst*/ 17'd42145 ),
    .hsync            ( HS         ),
    .vsync            ( VS         ),
    .csync            ( CSync      ),
    .din              ({15'b0,/*3'b111,6'b0*/ vdump}&{24{de}}     ),
    .dout             ( /*yc_vid*/     ),
    .hsync_o          ( /*hsync_c*/    ),
    .vsync_o          ( /*vsync_c*/    ),
    .csync_o          ( /*csync_c*/    )

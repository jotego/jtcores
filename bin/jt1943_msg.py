...
save_hex( os.environ['JTGNG']+"/cores/1943/mist/msg_mister.hex", char_ram )
...
save_hex( os.environ['JTGNG']+"/cores/1943/mist/msg.hex", char_ram )
save_bin( os.environ['JTGNG']+"/cores/1943/ver/game/msg.bin", char_ram )

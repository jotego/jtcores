...
save_hex( os.environ['JTGNG']+"/commando/mist/msg.hex", char_ram )
save_bin( os.environ['JTGNG']+"/commando/ver/game/msg.bin", char_ram )
...
save_hex( os.environ['JTGNG']+"/commando/mist/msg_av.hex", av_buf )
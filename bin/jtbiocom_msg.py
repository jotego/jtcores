...
save_hex( os.environ['JTROOT']+"/cores/biocom/mist/msg.hex", char_ram )
save_bin( os.environ['JTROOT']+"/cores/biocom/ver/game/msg.bin", char_ram )
...
save_hex( os.environ['JTROOT']+"/cores/biocom/mist/msg_av.hex", av_buf )

...
save_hex( os.environ['JTGNG']+"/cores/biocom/mist/msg.hex", char_ram )
save_bin( os.environ['JTGNG']+"/cores/biocom/ver/game/msg.bin", char_ram )
...
save_hex( os.environ['JTGNG']+"/cores/biocom/mist/msg_av.hex", av_buf )

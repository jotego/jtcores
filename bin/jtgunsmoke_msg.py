...
save_hex( os.environ['JTROOT']+"/cores/gunsmoke/mist/msg.hex", char_ram )
save_bin( os.environ['JTROOT']+"/cores/gunsmoke/ver/game/msg.bin", char_ram )
...
save_hex( os.environ['JTROOT']+"/cores/gunsmoke/mist/msg_av.hex", av_buf )
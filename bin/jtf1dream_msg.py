...
def save_bin(filename, data):
    try:
        ...
        print("WARNING: could not create file %s " % filename)
        print("       while creating message files ")
...
save_hex( os.environ['JTGNG']+"/f1dream/mist/msg.hex", char_ram )
save_bin( os.environ['JTGNG']+"/f1dream/ver/game/msg.bin", char_ram )
...
save_hex( os.environ['JTGNG']+"/f1dream/mist/msg_av.hex", av_buf )

...
You can find the list of supported games in [jtbin/game_list](https://github.com/jotego/jtbin/blob/master/game_list.md). That list is actually an output of the source code and gets updated every release. There are 1050+ supported titles at the moment ( January 2025 ).

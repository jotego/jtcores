...
jtgrad3_arbiter u_shram_arb(
    ...
    .b_req_n    ( s_sh_req_n   ),
    .a_rst_n    ( 1'b1         ),
    .a_grant_n  ( m_sh_gnt_n   ),
    .b_grant_n  ( s_sh_gnt_n   )
);

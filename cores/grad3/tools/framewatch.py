#!/usr/bin/env python3
"""framewatch - live viewer for Gradius III sim frames.

The sim writes frame_NNNNN images into
$JTCORES/cores/grad3/ver/gradius3/frames/ as it runs. This script starts
...
DEFAULT_DIR = pathlib.Path(__file__).resolve().parents[1] / "ver/gradius3/frames"
...
<html><head><meta charset=utf-8><title>grad3 sim frames</title>
<style>
  ...
  /* 4x pixel-perfect zoom for the 320px-wide arcade frame.
     Falls back to max-100% if the viewport is too small. */
  img{{image-rendering:pixelated;width:1280px;height:auto;

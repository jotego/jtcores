#!/usr/bin/env python3
"""Generate jtcninja_deco104_table.hex from MAME's port104_table[] (deco104.cpp).
...
directly (36 bits/entry) instead of expanding it to 16x5-bit weights (96 bits):
  ...
  [32]     use_nand
  [35:33]  0
See jtcninja_deco104.v for the matching unpack + nibble-rotate reorder().
"""
import re, os
...
SRC = os.path.join(HERE, "..", "doc", "deco104.cpp")
OUT = os.path.join(HERE, "jtcninja_deco104_table.hex")

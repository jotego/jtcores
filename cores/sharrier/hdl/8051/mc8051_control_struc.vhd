...
architecture struc of mc8051_control is
  ...
  signal state        : t_state;  -- JTSHARRIER: also exported on state_o  	-- actual state 
...
begin
  ...
  -- JTSHARRIER: expose the FSM state for instruction retiming. Encoded
  -- explicitly rather than left to the tool, so it matches the Verilog
  -- translation used by the simulator (FETCH = "001").

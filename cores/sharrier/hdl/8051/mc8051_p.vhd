...
package mc8051_p is
  ...
  component mc8051_control
    port (state_o        : out std_logic_vector(2 downto 0);  -- JTSHARRIER: FSM state, for retiming
  ...
  component mc8051_core
    port (clk         : in  std_logic;
          cen         : in  std_logic;
          cen_tmr     : in  std_logic;  -- JTSHARRIER: machine-cycle rate for tmr/siu
          state_o     : out std_logic_vector(2 downto 0);  -- JTSHARRIER: FSM state, for retiming
          reset       : in  std_logic;
          rom_data_i  : in  std_logic_vector(7 downto 0);
          ram_data_i  : in  std_logic_vector(7 downto 0);
          int0_i      : in  std_logic_vector(C_IMPL_N_EXT-1 downto 0);

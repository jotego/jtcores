# NeoGeo Pocket Color Compatible FPGA core by Jotego
...
Place your game files in the folder `games/NeoGeoPocket-Color` together with the firmware. Name the firmware file `boot.rom`.

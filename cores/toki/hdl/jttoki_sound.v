...
wire        [ 7:0] z80_dout, z80_ram_dout, dec_data, im0_opcode,
...
wire               rom_sel, bank_rom_sel, z80_ram_sel, ym_sel_0, ym_sel_1,
                   ...
                   main_data_pending_sel, read_coin_sel, bank_switch_sel,
                   sound_latch0_sel, sound_latch1_sel, oki_sel,
                   adpcm0_addr_sel, adpcm1_addr_sel, adpcm0_ctl_sel,
                   adpcm1_ctl_sel, irq_clear_sel, fm_eoi_sel,
                   main_eoi_sel, z80_ram_cs, ym_cs_0, ym_cs_1,
                   pending_set_cs, irq_clear_wr, fm_eoi_wr,
                   main_eoi_wr, z80_rd_n, z80_wr_n, z80_mem_acc,
                   z80_mem_wr, ym_rd, ym_wr, oki_rd, oki_wr,
                   z80_wait_cs, z80_wait_ok, z80_m1_n,
                   z80_mreq_n, z80_rfsh_n, z80_m1, z80_rst_n,
                   z80_irq_n, z80_iorq_n, ym3812_irq_n, jt51_irq_n,
                   z80_irq_ack, oki_wrn, fm_irq_n, main_eoi, ym_cs_n,
                   opl_wr_n, jt51_wr_n, adpcm_addr_hi,
                   adpcm0_addr_we, adpcm1_addr_we, adpcm0_ctl_we,
                   adpcm1_ctl_we;
reg         [ 7:0] z80_din;
reg                bank_selected, sub2main_pending;

assign z80_mem_acc           = ~z80_mreq_n & z80_rfsh_n;
assign z80_mem_wr            = z80_mem_acc & ~z80_wr_n;
assign rom_sel               = z80_addr < 16'h2000;
assign z80_ram_sel           = z80_addr >= 16'h2000 && z80_addr < 16'h2800;
assign pending_set_sel       = !cabal && z80_addr == 16'h4000;
assign irq_clear_sel         = z80_addr == 16'h4001;
assign fm_eoi_sel            = z80_addr == 16'h4002;
assign main_eoi_sel          = z80_addr == 16'h4003;
assign bank_switch_sel       = !cabal && z80_addr == 16'h4007;
assign ym_sel_0              = z80_addr == 16'h4008;
assign ym_sel_1              = z80_addr == 16'h4009;
assign m68k_latch0_sel       = z80_addr == 16'h4010;
assign m68k_latch1_sel       = z80_addr == 16'h4011;
assign main_data_pending_sel = z80_addr == 16'h4012;
assign read_coin_sel         = z80_addr == 16'h4013;
assign sound_latch0_sel      = z80_addr == 16'h4018;
assign sound_latch1_sel      = z80_addr == 16'h4019;
assign adpcm0_ctl_sel        = cabal && z80_addr == 16'h401a;
assign oki_sel               = !cabal && z80_addr == 16'h6000;
assign adpcm1_ctl_sel        = cabal && z80_addr == 16'h601a;
assign bank_rom_sel          = z80_addr >= 16'h8000;
assign adpcm0_addr_sel       = cabal && (z80_addr == 16'h4005 || z80_addr == 16'h4006);
assign adpcm1_addr_sel       = cabal && (z80_addr == 16'h6005 || z80_addr == 16'h6006);
...
assign irq_clear_wr    = z80_mem_wr & irq_clear_sel;
assign fm_eoi_wr       = z80_mem_wr & fm_eoi_sel;
assign main_eoi_wr     = z80_mem_wr & main_eoi_sel;
...
assign z80_irq_ack     = ~z80_iorq_n & ~z80_m1_n;
...
assign bank_rom_addr   = bank_selected ? z80_addr : z80_addr - 16'h8000;
...
assign adpcm_addr_hi   = ~z80_addr[0];
assign adpcm0_addr_we  = z80_mem_wr & adpcm0_addr_sel;
assign adpcm1_addr_we  = z80_mem_wr & adpcm1_addr_sel;
assign adpcm0_ctl_we   = z80_mem_wr & adpcm0_ctl_sel;
assign adpcm1_ctl_we   = z80_mem_wr & adpcm1_ctl_sel;
...
assign pcm0         = cabal ? {cabal_adpcm0_snd[11], cabal_adpcm0_snd, 1'b0} : oki_snd;
assign pcm1         = cabal ? {cabal_adpcm1_snd[11], cabal_adpcm1_snd, 1'b0} : 14'sd0;
...
always @(posedge clk) begin
    if (rst) begin
        ...
        z80_din <= z80_irq_ack                              ? im0_opcode :
